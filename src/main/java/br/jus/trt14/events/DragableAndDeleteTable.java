 ...
 * 
 */
public class DragableAndDeleteTable extends DropTarget {
    ...
    public DragableAndDeleteTable(final JTable jTable, List<String> acceptedTypes, JLabel jLabel, List<String> acceptedOtherFiles) {
        this.jTable = jTable;
