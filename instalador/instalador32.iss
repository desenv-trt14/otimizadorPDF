...
AllowNoIcons=yes
OutputDir=/
OutputBaseFilename=setup_32_rev_{#MyAppVersion}
...
Source: ..\gsdll32.dll; DestDir: {app}; Flags: ignoreversion
...
Filename: {app}\vcredist_x86.exe; Parameters:"/quiet /install"; Check: VCRedistNeedsInstall; StatusMsg: Instalando VC++ 2015 Redistributables... 
...
[UninstallRun]
Filename: {app}\print\uninstall.bat; Flags: shellexec runhidden  
Filename: {app}\removeatalho.vbs; Flags: shellexec runhidden
